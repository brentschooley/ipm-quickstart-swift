...
/** Called when one of the current users channels has fully loaded historical messages.
 ...
 @param channel The channel.
 */
- (void)ipMessagingClient:(TwilioIPMessagingClient *)client channelHistoryLoaded:(TMChannel *)channel;
...
/** Called when a message on a channel the current user is subscribed to is modified.
 ...
 @param message The message.
 */
- (void)ipMessagingClient:(TwilioIPMessagingClient *)client channel:(TMChannel *)channel messageChanged:(TMMessage *)message;
...
/** Called when a message on a channel the current user is subscribed to is deleted.
 ...
 @param message The message.
 */
- (void)ipMessagingClient:(TwilioIPMessagingClient *)client channel:(TMChannel *)channel messageDeleted:(TMMessage *)message;
